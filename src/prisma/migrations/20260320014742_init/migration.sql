...
CREATE TABLE "User" (
    ...
    "threadsRemaining" INTEGER NOT NULL DEFAULT 3,
    "threadsPurchased" INTEGER NOT NULL DEFAULT 0,
    "agentPrompt" TEXT,
    "preferredModel" TEXT NOT NULL DEFAULT 'openai/gpt-4o-mini',
...
CREATE TABLE "Purchase" (
    ...
    "threadsAmount" INTEGER NOT NULL,
